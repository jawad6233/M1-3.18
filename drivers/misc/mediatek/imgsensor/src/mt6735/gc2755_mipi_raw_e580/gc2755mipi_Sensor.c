...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2755_SENSOR_ID_E580,        //record sensor id defined in Kd_imgsensor.h
...
#ifdef CONFIG_TINTELE_PROJECT_DT900
...
static void sensor_init(void)
{
...
#if (defined CONFIG_TINTELE_DEVICE_MODEL_M1 || defined CONFIG_TINTELE_PROJECT_DT600) 
	write_cmos_sensor(0x17, 0x15); 
#else
	write_cmos_sensor(0x17, 0x16); 
#endif
...
#if (defined CONFIG_TINTELE_DEVICE_MODEL_M1 || defined CONFIG_TINTELE_PROJECT_DT600) 
	write_cmos_sensor(0x92, 0x03);
	write_cmos_sensor(0x94, 0x0a);//08
#else
	...
	write_cmos_sensor(0x02, 0x22); //Ink modify 00->11
	write_cmos_sensor(0x03, 0x12); //Ink modify 
...
UINT32 GC2755_MIPI_RAW_SensorInit_E580(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
