...
#define VOL_1000 1000000
...
#ifdef CONFIG_TINTELE_DEVICE_MODEL_S1
		pinSetIdx = 1;
#elif defined  CONFIG_TINTELE_DEVICE_MODEL_F1
	if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx)
		...
		pinSetIdx = 2;
#elif defined  CONFIG_TINTELE_DEVICE_MODEL_F2
	if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx)
		pinSetIdx = 1;
	else if (DUAL_CAMERA_SUB_SENSOR == SensorIdx)
		pinSetIdx = 0;
	...
	if (On) {
		...
		PK_DBG("[PowerON] undefine CONFIG_MTK_LEGACY pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);

		if ((currSensorName && (0 == strcmp(currSensorName,"ov13850mipiraw2a")))||
			 (currSensorName && (0 == strcmp(currSensorName,"s5k3m2mipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"s5k5e2yamipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"s5k5e8yxmipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"imx179mipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"ov5648mipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"ov8865mipiraw")))){
			...
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
					...
					(currSensorName && (0 == strcmp(currSensorName,"gc2755mipiraw_e580")))||	
					(currSensorName && (0 == strcmp(currSensorName,"gc5005mipiraw"))))	{
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		{
			printk ("camera sensor is not config");	
		}	
	} else { /* power OFF */
		PK_DBG("[PowerOFF]undefine CONFIG_MTK_LEGACY pinSetIdx:%d\n", pinSetIdx);
		...
		if ((currSensorName && (0 == strcmp(currSensorName,"ov13850mipiraw2a")))||
			 ...
			 (currSensorName && (0 == strcmp(currSensorName,"s5k5e8yxmipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"imx179mipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"5648mipiraw")))||
			 (currSensorName && (0 == strcmp(currSensorName,"ov8865mipiraw")))){
