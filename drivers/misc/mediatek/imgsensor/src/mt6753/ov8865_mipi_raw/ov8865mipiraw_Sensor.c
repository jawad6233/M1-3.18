...
//Ink 2016.01.22
	...
	write_cmos_sensor(0x3820,0x00);//;chenwj
	write_cmos_sensor(0x3821,0x06);//; hsync_en_o, fst_vbin, mirror on
#else
	write_cmos_sensor(0x3820,0x06);//;chenwj
	write_cmos_sensor(0x3821,0x00);//; hsync_en_o, fst_vbin, mirror on
#endif
//end
