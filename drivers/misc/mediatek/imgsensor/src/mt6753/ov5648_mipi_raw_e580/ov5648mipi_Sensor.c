...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV5648MIPI_SENSOR_ID_E580,
...
static void sensor_init(void)
{
    ...
    */
    ...
    write_cmos_sensor(0x3821, 0x08); // mirror on, h bin on
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    /********************************************************
       ...
       ********************************************************/
    write_cmos_sensor(0x3820, 0x47); // flip off, v bin off
    write_cmos_sensor(0x3821, 0x08); // mirror on, v bin off
...
UINT32 OV5648MIPISensorInit_E580(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
