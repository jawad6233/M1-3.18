...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV5648MIPI_SENSOR_ID_DT800,
...
static void sensor_init(void)
{
    ...
    */
    ...
    // Horizontal binning
    write_cmos_sensor(0x3820, 0x47); // flip off, v bin off
    write_cmos_sensor(0x3821, 0x0e); // mirror on, h bin on
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    /********************************************************
       ...
       ********************************************************/
    write_cmos_sensor(0x3820, 0x47); // flip off, v bin off
    write_cmos_sensor(0x3821, 0x0e); // mirror on, v bin off
...
// just for dt800
int is_camera_sensor_ov5648;
is_camera_sensor_ov5648=0;
#endif
...
UINT32 OV5648MIPISensorInit_DT800(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
