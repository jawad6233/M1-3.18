...
/*capture_first_flag_1a & pre_currefps_1a for resolve ov13850r2a 
* low light zsd capture color-line issue
*/
int capture_first_flag_1a = 0;
int pre_currefps_1a = 0;
static void capture_setting(kal_uint16 currefps)
{
    LOG_INF("E! currefps:%d\n",currefps);

if (pre_currefps_1a != currefps)
{
	capture_first_flag_1a = 0;
	pre_currefps_1a = currefps;
}
else
{
	capture_first_flag_1a = 1;
}
if (capture_first_flag_1a == 0)
{
