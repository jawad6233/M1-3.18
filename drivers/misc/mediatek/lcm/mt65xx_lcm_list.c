...
#if defined(ILI9881C_HD720_VDO)
	&ili9881c_hd720_vdo_lcm_drv,
#endif
//liangcw 2016.03.02
#if defined(OTM1287A_HD720_TIN_VDO)
	&otm1287a_hd720_tin_vdo_lcm_drv,
#endif
//end

//Ink 2014.12.03
#if defined(OTM1284_TIN_VDO)
	&otm1284_tin_vdo_lcm_drv,
#endif
#if defined(OTM1284_HD720_VDO)
	&otm1284_hd720_vdo_lcm_drv,
#endif
#if defined(JDI0012_FHD_DSI_VDO)
	&jdi0012_fhd_dsi_vdo_lcm_drv,
#endif
//end

//xiaopei 2015.12.18
#if defined(OTM1284A_HD720_VDO)
	&otm1284a_hd720_vdo_drv,
#endif
//end
#if defined(OTM1287A_HD720_TIN_VDO)
	&otm1287a_hd720_tin_vdo_lcm_drv,
...
#endif
#if defined(NT35695_FHD_DSI_CMD_YASSY)
	&nt35695_fhd_dsi_cmd_yassy_lcm_drv,
#endif
...
#endif
//liangcw add 
#if defined(RM68191_QHD_DSI_VDO_TRULY)
	&rm68191_qhd_dsi_vdo_truly_lcm_drv,
#endif
//end
...
//chenwj
#if defined(HX8363_TIN_VDO)
       &hx8363_tin_vdo_lcm_drv,
#endif
...
//Runbo Ink 2016.08.06
#if defined(NT35532_FHD_DSI_VDO)
	&nt35532_fhd_dsi_vdo_lcm_drv,
#endif
#if defined(NT35596_FHD_DSI_VDO)
	&nt35596_fhd_dsi_vdo_lcm_drv,
#endif
//end
...
#if defined(ST7796S_QVGA_VDO)
	&st7796s_qvga_vdo_lcm_drv,
#endif
