...
static int sim_switch_probe(struct platform_device *dev)
{
	...
	//hot_plug_mode1 = pinctrl_lookup_state(ssw_pinctrl, "hot_plug_mode1");//Runbo,BruceLai;2016-08-18 annotate hot_plug
	two_sims_bound_to_md1 =
	    pinctrl_lookup_state(ssw_pinctrl, "two_sims_bound_to_md1");

	//hot_plug_mode2 = pinctrl_lookup_state(ssw_pinctrl, "hot_plug_mode2");//Runbo,BruceLai;2016-08-18 annotate hot_plug
	sim1_md3_sim2_md1 =
