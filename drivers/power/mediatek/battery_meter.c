...
/* 5. Logging */
                 ...
                 printk(" %d-%02d-%02d %02d:%02d:%02d ",tm.tm_year + 1900, tm.tm_mon + 1,tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);

	bm_print(BM_LOG_CRTI,
		 "[FGADC] gFG_Is_Charging:%d,gFG_current:%d,gFG_columb:%d,gFG_voltage:%d,gFG_capacity_by_v:%d,gFG_capacity_by_c:%d,gFG_capacity_by_c_init:%d,gFG_BATT_CAPACITY:%d,gFG_BATT_CAPACITY_aging:%d,gFG_compensate_value: %d,gFG_ori_voltage:%d,board_compesate:%d, board_slope:%d,gFG_voltage_init:%d,minerroroffset:%d,g_FG_DODO:%d,g_FG_DOD1:%d,car_tune_value:%d,tuning_value:%d\r\n",
