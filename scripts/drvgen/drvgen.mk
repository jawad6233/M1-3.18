...
#Begin [Linzq, 2015-03-09] Use corresponding codegen.dws with different project
ifneq ($(wildcard $(srctree)/arch/arm/mach-$(MTK_PLATFORM)/$(MTK_PROJECT)/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/$(HW_PROJECT)_codegen.dws),)
...
#Begin [Linzq, 2015-03-09] Use corresponding codegen.dws with different project
DWS_FILE := $(srctree)/$(DRVGEN_PATH)/$(HW_PROJECT)_codegen.dws
#End
